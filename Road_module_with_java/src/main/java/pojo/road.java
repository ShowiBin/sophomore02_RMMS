...
public class road {
    ...
    public String toString() {
        return "road{" +
                ...
                ", road_lmdj='" + road_lmdj + '\'' +
                ", road_sjss='" + road_sjss + '\'' +
                ", road_lfkdfw='" + road_lfkdfw + '\'' +
                ", road_dlcd=" + road_dlcd +
                ", road_dlmj=" + road_dlmj +
                ", road_AADT='" + road_AADT + '\'' +
                ", road_jtldj='" + road_jtldj + '\'' +
                ", road_ssxz='" + road_ssxz + '\'' +
                ", road_glfl='" + road_glfl + '\'' +
                ", road_gldw='" + road_gldw + '\'' +
                ", road_yhdw='" + road_yhdw + '\'' +
    ...
    public Float getRoad_dlcd() {
        return road_dlcd;
    }

    public void setRoad_dlcd(Float road_dlcd) {
        this.road_dlcd = road_dlcd;
    }

    public Float getRoad_dlmj() {
        return road_dlmj;
    }

    public void setRoad_dlmj(Float road_dlmj) {
